...
import 'package:open_target_sa/services/firebase_services_playeras.dart';
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: PlayerasPage(title: 'Playeras'),
    );
  }
}

class PlayerasPage extends StatefulWidget {
  PlayerasPage({Key key, this.title}) : super(key: key);
...
class _MyHomePageState extends State<PlayerasPage> {
