...
import 'package:open_target_sa/services/firebase_services_tablet.dart';
...
class TabletPage extends StatefulWidget {
  TabletPage({Key key, this.title}) : super(key: key);
...
class _MyHomePageState extends State<TabletPage> {
