...
import 'package:open_target_sa/services/frebase_sesrvices_acc.dart';
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: AccPage(title: 'Pocket Accesorios'),
    );
  }
}

class AccPage extends StatefulWidget {
  AccPage({Key key, this.title}) : super(key: key);
...
class _MyHomePageState extends State<AccPage> {
  ...
  Widget build(BuildContext context) {
    ...
    Widget image_carousel = new Container(
      ...
      child: new Carousel(
        boxFit: BoxFit.fill,
        images: [
          AssetImage('images/accbanner.png'),
